...
const managerCard = (teamMember) => {
    return `<div class="card my-2 shadow" style="width: 18rem;">
<div class="card-header bg-primary">
    <h3 class="text-center text-light"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cup-hot-fill" viewBox="0 0 16 16">
    ...
    <h5 class="font-weight-bold text-center text-light">${teamMember.name}</h5>
</div>
<ul class="list-group list-group-flush">
  <li class="list-group-item text-monospace">ID#: ${teamMember.id}</li>
  <li class="list-group-item text-monospace">Email: <a href = "mailto:${teamMember.email}">${teamMember.email}</a></li>
  <li class="list-group-item text-monospace">Office#: ${teamMember.officeNumber}</li>
</ul>
</div>
`;
}
const engineerCard = (teamMember) => {
    return `<div class="card my-2 shadow" style="width: 18rem;">
<div class="card-header bg-primary">
    <h3 class="text-center text-light"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-wrench-adjustable-circle-fill" viewBox="0 0 16 16">
...
<ul class="list-group list-group-flush">
  <li class="list-group-item text-monospace">ID#: ${teamMember.id}</li>
  <li class="list-group-item text-monospace"><a href = "mailto:${teamMember.email}">${teamMember.email}</a></li>
  <li class="list-group-item text-monospace">Github Username: <a href="https://github.com/${teamMember.gitHub}" target="_blank">${teamMember.gitHub}</a></li>
</ul>
</div>
`;
}
const internCard = (teamMember) => {
    return `<div class="card my-2 shadow" style="width: 18rem;">
<div class="card-header bg-primary">
    <h3 class="text-center text-light"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-mortarboard-fill" viewBox="0 0 16 16">
...
<ul class="list-group list-group-flush">
  <li class="list-group-item text-monospace">ID#: ${teamMember.id}</li>
  <li class="list-group-item text-monospace"><a href = "mailto:${teamMember.email}">${teamMember.email}</a></li>
  <li class="list-group-item text-monospace">School: ${teamMember.school}</li>
</ul>
</div>
`;
}
...
generateTeamPageHtml = () => {
    ...
    <body>
        <header class="container-fluid align-items-center bg-danger p-3" style="height: 90px">
            <h1 class="font-weight-bolder text-center text-light">MY TEAM</h1>
        </header>
...
function writeToFile(fileNamePath) {
    //function using file system to write html file
    fs.writeFile(fileNamePath, generateTeamPageHtml(team), (err) =>
        err ? console.error(err) : console.log('An HTML file has been created for your project!')
    )
};
//function to initialize index.html creation
function init() {
